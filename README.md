...
* MQTT Broker:  Làm nhiệm vụ nhận và phân phối các thông báo từ ESP32 đến ứng dụng và ngược lại.  Xay dung may chu cho mang cuc bo voi (Mosquitto MQTT broker) hoac su dung cac may chu truc tuyen nhu HiveMQ
